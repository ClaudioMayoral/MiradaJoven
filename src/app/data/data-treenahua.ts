...
export class DataTreeNahua{
    //Level 0
    static main:Card[] = [
        { title:"¿Amig_s o novi_s?(Nahua)",content:"¿Quieres saber todo sobre ligue?" ,icon:"/assets/icon/1-amigues.svg", route: '/como-me-siento/amigxs-o-novixs', bgColor:'#FF3366', enabled:true },
    ...
    //Level 1
    static ligando:Card[] = [
        { title:"Cuidando mi cuerpo(Nahua)",content:"",icon:"/assets/icon/cuidando-mi-cuerpo.svg",route: '/como-me-siento/amigxs-o-novixs/cuidando-mi-cuerpo', bgColor:'#FF3366',enabled:true },
    ...
    static modoNerd:Card[] = [
        { title:"Tus derechos(Nahua)",content:" ",icon:"/assets/icon/tus-derechos.svg",route: '/como-me-siento/curiosx/tus-derechos', bgColor: '#F97F06',enabled:true },
    ...
    static weba:Card[] = [
        { title:"Generación 2030(Nahua)",content:"", icon:"/assets/icon/generacion-2030.svg",route: '/como-me-siento/participa/generacion-2030', bgColor: '#FCC103',enabled:true },
    ...
    static zombie:Card[] = [
        ...
        { title:"Adicciones(Nahua)",content:" ",icon:"/assets/icon/adicciones.svg",route: '/como-me-siento/zombi/adiccionesZombi', bgColor: '#42DABF',enabled:true },
    ];

    //Level 2
    static cuidandoMiCuerpo:Card[] = [
        { title:"¡Haz valer tus derechos!(Nahua)",content:"",icon:"/assets/icon/haz-valer-tus-derechos.svg",route: '/como-me-siento/amigxs-o-novixs/cuidando-mi-cuerpo/valer-tus-derechos', bgColor: '#FF3366',enabled:true },
    ...
    static sexualidad:Card[] = [
        { title:"Modo cachondo(Nahua)",content:"",icon:"/assets/icon/modo-cachondo.svg",route: '/como-me-siento/amigxs-o-novixs/sexualidad/modo-cachondo', bgColor: '#FF3366',enabled:true },
    ...
    static violencia:Card[] = [
        { title:"Violencia digital(Nahua)",content:" ",icon:"/assets/icon/violencia-digital.svg",route: '/como-me-siento/amigxs-o-novixs/violencia/violencia-digital', bgColor:'#FF3366',enabled:true },
    ...
    static generacion2030:Card[] = [
        { title:"Yo, agente de cambio(Nahua)",content:" ",icon:"/assets/icon/agente-de-cambio.svg",route: '/como-me-siento/participa/generacion-2030/yo-agente-de-cambio', bgColor:'#FCC103',enabled:true },
    ...
    static eventos:Card[] = [
        { title:"Salón de Eventos(Nahua)",content:" ",icon:"/assets/icon/salon-de-eventos-2.svg",route: '/como-me-siento/participa/eventos/salon-de-eventos', bgColor:'#FCC103',enabled:true },
    ...
    static emprendimiento:Card[] = [
        { title:"Salón de Eventos(Nahua)",content:" ",icon:"/assets/icon/violencia.svg",route: '', bgColor:'#FCC103',enabled:true },
    ...
    static laDepre:Card[] = [
        { title:"No puedo superar esto(Nahua)",content:"", icon:"/assets/icon/la-depre.svg",route: '', bgColor: '#42DABF', enabled:false },
    ...
    static yaNoAguanto:Card[] = [
        { title:"¡Decir que No!(Nahua)",content:"", icon:"/assets/icon/ya-no-aguanto.svg",route: '', bgColor: '#6A30B5',enabled:false },
    ...
    static emociones:Card[] = [
        { title:"Siento celos ¿es normal?(Nahua)",content:" ", icon:"/assets/icon/emociones.svg",route: '', bgColor: '#1AA086',enabled:false },
    ...
    static algoNoAndaBien:Card[] = [
        { title:"No puedo concentrarme, me distraigo mucho(Nahua)",content:" ",icon:"/assets/icon/algo-no-anda-bien.svg",route: '', bgColor: '#1AA086',enabled:false },
    ...
    static adicciones:Card[] = [
        { title:"Adicciones sin sustancia(Nahua)",content:" ",icon:"/assets/icon/adicciones.svg",route: '', bgColor: '#1AA086',enabled:false },
    ...
    static amorYRelaciones:Card[] = [
        { title:"¿Qué es el deseo sexual?(Nahua)",content:" ",icon:"/assets/icon/amor-y-relaciones.svg",route: '', bgColor:'#FF3366' },
    ...
    static curiosidad:Card[] = [
        { title:"Mi Cuerpo(Nahua)",content:" ",icon:"/assets/icon/curiosidad.svg",route: '/como-me-siento/amigxs-o-novixs/curiosidad/miCuerpo', bgColor:'#FF3366',enabled:true },
    ...
    static miCuerpo:Card[] = [
        { title:"Vivir con VIH(Nahua)",content:" ",icon:"/assets/icon/stethoscope.png",route: 'http', bgColor:'#FF3366',enabled:true },
    ...
    static participando:Card[] = [
        { title:"Cine en casa(Nahua)",content:" ",icon:"/assets/icon/participando.svg",route: '', bgColor: '#F97F06',enabled:false }
    ];

    static habilidades:Card[] = [
        { title:"Habilidades socioemocionales para jóvenes(Nahua)",content:" ",icon:"/assets/icon/habilidades.svg",route: '', bgColor: '#F97F06',enabled:false }
    ];


    static derechosHumanos:Card[] = [
        { title:"¿Qué son los derechos humanos?(Nahua)",content:" ",icon:"/assets/icon/Derechos-humanos.svg",route: '', bgColor: '#F97F06',enabled:false }
    ];


    static quePasaria:Card[] = [
        { title:"¿Qué pasaría si los hombres fueran mujeres?(Nahua)",content:" ",icon:"/assets/icon/que-pasaria-si.svg",route: '', bgColor: '#F97F06',enabled:false }
    ];
